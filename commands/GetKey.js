...
const liner = new lineByLine(`${process.cwd()}/commands/private/test.txt`);
...
var myRawFile = fs.readFileSync(`${process.cwd()}/commands/private/test.txt`);
...
myFile = lines.join('\n');
fs.writeFileSync(`${process.cwd()}/commands/private/test.txt`, myFile);
